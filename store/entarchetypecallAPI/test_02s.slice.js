...
export const api_v1_test_02_list = createAsyncThunk(
  "test_02s/api_v1_test_02_list",
  async payload => {
    const response = await apiService.api_v1_test_02_list(payload)
    return response.data
  }
)
export const api_v1_test_02_create = createAsyncThunk(
  "test_02s/api_v1_test_02_create",
  async payload => {
    const response = await apiService.api_v1_test_02_create(payload)
    return response.data
  }
)
export const api_v1_test_02_retrieve = createAsyncThunk(
  "test_02s/api_v1_test_02_retrieve",
  async payload => {
    const response = await apiService.api_v1_test_02_retrieve(payload)
    return response.data
  }
)
export const api_v1_test_02_update = createAsyncThunk(
  "test_02s/api_v1_test_02_update",
  async payload => {
    const response = await apiService.api_v1_test_02_update(payload)
    return response.data
  }
)
export const api_v1_test_02_partial_update = createAsyncThunk(
  "test_02s/api_v1_test_02_partial_update",
  async payload => {
    const response = await apiService.api_v1_test_02_partial_update(payload)
    return response.data
  }
)
export const api_v1_test_02_destroy = createAsyncThunk(
  "test_02s/api_v1_test_02_destroy",
  async payload => {
