...
export const api_v1_testmodelinfoo_list = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_list", async payload => {
  const response = await apiService.api_v1_testmodelinfoo_list(payload);
  return response.data;
});
export const api_v1_testmodelinfoo_create = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_create", async payload => {
  const response = await apiService.api_v1_testmodelinfoo_create(payload);
  return response.data;
});
export const api_v1_testmodelinfoo_retrieve = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_retrieve", async payload => {
  const response = await apiService.api_v1_testmodelinfoo_retrieve(payload);
  return response.data;
});
export const api_v1_testmodelinfoo_update = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_update", async payload => {
  const response = await apiService.api_v1_testmodelinfoo_update(payload);
  return response.data;
});
export const api_v1_testmodelinfoo_partial_update = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_partial_update", async payload => {
  const response = await apiService.api_v1_testmodelinfoo_partial_update(payload);
  return response.data;
});
export const api_v1_testmodelinfoo_destroy = createAsyncThunk("testModelInFoos/api_v1_testmodelinfoo_destroy", async payload => {
