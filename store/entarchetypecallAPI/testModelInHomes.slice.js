...
export const api_v1_testmodelinhome_list = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_list", async payload => {
  const response = await apiService.api_v1_testmodelinhome_list(payload);
  return response.data;
});
export const api_v1_testmodelinhome_create = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_create", async payload => {
  const response = await apiService.api_v1_testmodelinhome_create(payload);
  return response.data;
});
export const api_v1_testmodelinhome_retrieve = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_retrieve", async payload => {
  const response = await apiService.api_v1_testmodelinhome_retrieve(payload);
  return response.data;
});
export const api_v1_testmodelinhome_update = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_update", async payload => {
  const response = await apiService.api_v1_testmodelinhome_update(payload);
  return response.data;
});
export const api_v1_testmodelinhome_partial_update = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_partial_update", async payload => {
  const response = await apiService.api_v1_testmodelinhome_partial_update(payload);
  return response.data;
});
export const api_v1_testmodelinhome_destroy = createAsyncThunk("testModelInHomes/api_v1_testmodelinhome_destroy", async payload => {
