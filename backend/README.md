...
## Project Structure
    ...
    ├── ent_archetype_call__42705  # Django project configurations
...
1. Clone this repo and `cd ent_archetype_call__42705`
...
2. Clone this repo and `cd ent_archetype_call__42705`
